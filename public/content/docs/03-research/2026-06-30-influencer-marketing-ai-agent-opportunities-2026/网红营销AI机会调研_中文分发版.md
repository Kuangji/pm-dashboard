...
|---|---|---|---|---|
| P0 | 营销简报到达人候选名单智能体 | 用户输入品牌、商品、目标、预算、地区和禁忌项后，系统自动生成搜索策略、候选达人、推荐理由和风险解释 | LLM 语义理解、多语言扩词、语义检索和 Nox 已有搜索/相似达人/CRM 基础成熟 | 搜索、AI 搜索、智能营销计划、待邀约池、CRM |
...
| 优先级 | 机会点 | 判断 |
|---|---|---|
| P0 | 营销简报到达人候选名单智能体 | 最贴近搜索入口，也最容易验证效率提升 |
...
| 实验 | 验证假设 | 做法 | 成功标准 |
|---|---|---|---|
| 历史营销简报离线对照 | 用户愿意让 AI 从营销简报生成候选名单 | 选 5 个历史营销简报，用 AI 生成候选名单，与人工名单/普通搜索对比 | AI 候选名单保留率高于普通搜索 20% 以上 |
...
1. 先做 **营销简报到达人候选名单智能体**，验证 AI 是否能显著提高选人效率和推荐质量。

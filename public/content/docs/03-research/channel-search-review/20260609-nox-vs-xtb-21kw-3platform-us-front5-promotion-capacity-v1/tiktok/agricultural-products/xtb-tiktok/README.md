# xtb tiktok agricultural products

一句话结论：xtb / tiktok / agricultural products: 250 条已评分，badcase率 52.0%，fit 59、adjacent 61、badcase 130。
平均 shard 执行时间：133.9s；平均单频道执行时间：6.9s。

# nox instagram vacuum cleaner

一句话结论：nox / instagram / vacuum cleaner: 250 条已评分，badcase率 28.8%，fit 81、adjacent 97、badcase 72。
平均 shard 执行时间：179.9s；平均单频道执行时间：7.2s。

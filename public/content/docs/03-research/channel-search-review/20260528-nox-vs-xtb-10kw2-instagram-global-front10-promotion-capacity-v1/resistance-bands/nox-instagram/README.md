# nox instagram resistance bands

一句话结论：nox / instagram / resistance bands: 500 条已评分，badcase率 5.6%，fit 229、adjacent 243、badcase 28。
平均 shard 执行时间：152.5s；平均单频道执行时间：6.4s。

# xtb instagram resistance bands

一句话结论：xtb / instagram / resistance bands: 500 条已评分，badcase率 10.4%，fit 228、adjacent 220、badcase 52。
平均 shard 执行时间：128.9s；平均单频道执行时间：5.2s。

# xtb instagram photography equipment

一句话结论：xtb / instagram / photography equipment: 500 条已评分，badcase率 19.0%，fit 223、adjacent 182、badcase 95。
平均 shard 执行时间：134.2s；平均单频道执行时间：5.6s。

# nox instagram photography equipment

一句话结论：nox / instagram / photography equipment: 500 条已评分，badcase率 40.0%，fit 144、adjacent 156、badcase 200。
平均 shard 执行时间：127.9s；平均单频道执行时间：5.1s。

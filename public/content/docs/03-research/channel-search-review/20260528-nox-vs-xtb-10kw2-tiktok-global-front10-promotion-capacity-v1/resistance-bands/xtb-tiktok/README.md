# xtb tiktok resistance bands

一句话结论：xtb / tiktok / resistance bands: 500 条已评分，badcase率 20.4%，fit 185、adjacent 213、badcase 102。
平均 shard 执行时间：174.2s；平均单频道执行时间：12.5s。

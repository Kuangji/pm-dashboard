# nox tiktok resistance bands

一句话结论：nox / tiktok / resistance bands: 500 条已评分，badcase率 28.6%，fit 173、adjacent 184、badcase 143。
平均 shard 执行时间：172.9s；平均单频道执行时间：6.9s。

# nox tiktok digital products

一句话结论：nox / tiktok / digital products: 500 条已评分，badcase率 25.6%，fit 278、adjacent 94、badcase 128。
平均 shard 执行时间：123.8s；平均单频道执行时间：5.2s。

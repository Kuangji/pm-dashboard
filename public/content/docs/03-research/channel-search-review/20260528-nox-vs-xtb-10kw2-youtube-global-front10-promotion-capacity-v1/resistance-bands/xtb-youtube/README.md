# xtb youtube resistance bands

一句话结论：xtb / youtube / resistance bands: 500 条已评分，badcase率 10.4%，fit 252、adjacent 196、badcase 52。
平均 shard 执行时间：144.3s；平均单频道执行时间：12.6s。

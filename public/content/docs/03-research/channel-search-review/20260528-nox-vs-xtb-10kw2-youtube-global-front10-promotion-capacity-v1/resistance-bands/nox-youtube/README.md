# nox youtube resistance bands

一句话结论：nox / youtube / resistance bands: 500 条已评分，badcase率 18.2%，fit 129、adjacent 280、badcase 91。
平均 shard 执行时间：164.6s；平均单频道执行时间：7.2s。

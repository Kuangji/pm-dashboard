# xtb youtube digital products

一句话结论：xtb / youtube / digital products: 500 条已评分，badcase率 7.4%，fit 302、adjacent 161、badcase 37。
平均 shard 执行时间：150.7s；平均单频道执行时间：11.3s。

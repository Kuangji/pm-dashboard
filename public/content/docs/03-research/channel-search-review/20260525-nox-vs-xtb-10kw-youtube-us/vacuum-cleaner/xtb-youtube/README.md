# xtb youtube vacuum cleaner

一句话结论：xtb / youtube / vacuum cleaner: 1500 条已评分，badcase率 67.8%，fit 262、adjacent 221、badcase 1017。
平均 shard 执行时间：93.8s；平均单频道执行时间：36.6s。

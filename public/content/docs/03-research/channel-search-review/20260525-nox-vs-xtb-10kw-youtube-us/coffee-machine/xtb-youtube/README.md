# xtb youtube coffee machine

一句话结论：xtb / youtube / coffee machine: 1500 条已评分，badcase率 81.6%，fit 142、adjacent 134、badcase 1224。
平均 shard 执行时间：104.0s；平均单频道执行时间：35.4s。
